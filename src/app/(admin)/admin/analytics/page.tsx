      ...
      <div className="max-w-2xl mx-auto text-center space-y-8">
        ...
        <div className="space-y-3">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Comprehensive analytics and insights are under development. Soon you'll be able to track
            platform performance, user engagement, and key metrics to help optimize the learning
            experience.
          </p>
        </div>
