    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">people waiting for access</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {waitlistData.length > 0
                ? formatDistanceToNow(new Date(waitlistData[0].created_at), { addSuffix: true })
                : "No activity"}
            </div>
            <p className="text-xs text-muted-foreground">last signup</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Browse and search through waitlist submissions</CardDescription>
        </CardHeader>
        <CardContent>
