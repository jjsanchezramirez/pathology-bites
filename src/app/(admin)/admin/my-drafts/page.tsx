...
import { Eye, Search, Edit3, Send, RefreshCw, FileText } from "lucide-react";
...
export default function MyDraftsPage() {
  ...
  const allSelected =
    filteredQuestions.length > 0 && selectedQuestions.size === filteredQuestions.length;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Button variant="outline" size="sm" onClick={fetchDraftQuestions} disabled={loading}>
                ...
                <TableRow key={question.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Button variant="ghost" size="sm" onClick={() => handlePreview(question.id)}>
