...
const DEFAULT_AUDIO_URL =
  "https://pub-9b9085c172ac445ca3d87dec27a0518f.r2.dev/explanations/Castleman%20Disease.mp3";
          ...
          {selectedImageIndex !== null && selectedImages[selectedImageIndex] && (
            <div className="w-80 border-l bg-white overflow-y-auto">
                                  ...
                                  onBlur={(e) => {
                                    ...
                                    if (!isNaN(val)) {
                                      updateText(selectedImageIndex, text.id, {
                                        start: Math.max(
                                          0,
                                          Math.min(selectedImages[selectedImageIndex].duration, val)
                                        ),
                                      });
                                    }
                                  }}
              ...
              <div className="p-4 border-t">
                <Button onClick={generateSequence} className="w-full" variant="default">
                  Update Preview
                </Button>
              </div>
            </div>
