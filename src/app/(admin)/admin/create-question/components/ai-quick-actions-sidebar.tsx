...
import { Brain, Sparkles, Loader2, Wand2, Tags, FolderTree, BarChart3, Zap } from "lucide-react";
  ...
  return (
    <Card className="sticky top-6 shadow-sm">
      <CardHeader className="pb-4 space-y-1">
        ...
        <CardDescription className="text-sm">Quick actions and custom refinements</CardDescription>
      </CardHeader>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            {quickActions.map((action) => {
              ...
              const isDisabled =
                (action.requiresContent && !hasBasicContent) || isLoading || activeAction !== null;
