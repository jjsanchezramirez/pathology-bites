        ...
        <div className="container mx-auto px-6 max-w-6xl z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            <div className="w-full lg:w-3/5 space-y-6 text-center lg:text-left">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0">
                We're working hard to bring you a new pathology learning platform. Stay tuned for
                our official launch on August 1st, 2025.
              </p>
          ...
          >
            <p className="text-sm text-center text-muted-foreground mb-2">
              Learn more about Pathology Bites
            </p>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Pathology Bites will feature hundreds of high-quality questions to test and enhance
              your knowledge. Here's a sample from our question bank:
            </p>
          </div>
          <DemoQuestion />
        </div>
        ...
        <div className="container mx-auto px-4 py-24 relative">
          <div className="mx-auto max-w-3xl space-y-6 text-center">
            ...
            <p className="text-lg text-primary-foreground/90">
              Be the first to know when Pathology Bites goes live. Subscribe to receive launch
              updates.
            </p>
