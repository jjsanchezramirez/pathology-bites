    ...
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Test and explore all toast notification features
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Standard toast notifications for different scenarios
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Button
              onClick={() => toast.error('Critical error - requires manual dismissal', { duration: Infinity })}
              className="w-full"
              variant="destructive"
            >
              Persistent Toast (∞)
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Create your own custom toast with custom settings
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="flex gap-2">
              <Button
                onClick={() => {
                  const type = (document.getElementById('toast-type') as HTMLSelectElement)?.value || 'success'
              ...
              <Button
                onClick={() => {
                  navigator.clipboard.writeText(`toast.success('${customMessage}', { duration: ${customDuration} })`)
        ...
        <Card className="lg:col-span-2 bg-muted">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              For complete documentation on using toast notifications, including best practices,
              API reference, and advanced examples, see:
            </p>
            ...
            <div className="mt-4 p-4 bg-background rounded-md">
              ...
              <code className="text-sm">import &#123; toast &#125; from '@/shared/utils/toast'</code>
            </div>
          </CardContent>
        </Card>
      </div>
