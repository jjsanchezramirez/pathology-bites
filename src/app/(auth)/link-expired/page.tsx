  ...
  const getContent = () => {
    if (type === "recovery") {
      return {
        ...
        content:
          "Password reset links expire for security reasons. Please request a new password reset link to continue.",
        primaryAction: {
    ...
    return {
      ...
      content:
        "Email verification links expire for security reasons. Please request a new verification email to activate your account.",
      primaryAction: {
      ...
      <StatusCard
        ...
        footer={
          <Button asChild className="w-full">
            <Link href={content.primaryAction.href}>{content.primaryAction.text}</Link>
          </Button>
        }
      />
    </AuthPageLayout>
