      ...
      <div className="max-w-2xl mx-auto text-center space-y-8">
        ...
        <div className="space-y-3">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Structured courses with interactive content and assessments are being developed. Soon
            you'll be able to learn pathology through comprehensive, step-by-step modules designed
