...
import { Brain, Play, Settings, Target, BookOpen, Lightbulb, TrendingUp } from "lucide-react";
      ...
      <div className="text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Learn with immediate feedback and detailed explanations. Perfect for building
            understanding and reinforcing key concepts in pathology.
          </p>
        </div>
      </div>
