      ...
      messages: [
        {
          role: "system",
          content:
            "You are a medical education expert specializing in pathology. Generate high-quality multiple-choice questions following the exact JSON schema provided.",
        },
        {
          role: "user",
          content: prompt,
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a medical education expert. Generate pathology questions in valid JSON format only.",
        },
        {
          role: "user",
          content: prompt,
