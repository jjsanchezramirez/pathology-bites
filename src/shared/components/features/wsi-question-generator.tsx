...
const WSI_FALLBACK_MODEL_NAMES = ACTIVE_AI_MODELS.filter((model) => model.available).map(
  (model) => model.name
);
          ...
          <div className="w-full">
            ...
            <div className="mt-2 text-xs text-muted-foreground text-center">
              <div>
                ...
                <span className="font-bold">Ace My Path</span>. All credits belong to the original
                authors.
              </div>
              {currentQuestion.wsi.source_metadata?.authors &&
                Array.isArray(currentQuestion.wsi.source_metadata.authors) &&
                currentQuestion.wsi.source_metadata.authors.length > 0 && (
                  <div className="mt-1">
