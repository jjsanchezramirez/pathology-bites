...
export function PageSEO({
  ...
  return (
    <>
      ...
      {/* Question Schema */}
      {question && <QuestionSchema question={question} />}
      ...
      {/* Custom Schema */}
      {customSchema && <StructuredData data={customSchema} />}
    </>
  );
}
...
export function generateAboutPageMetadata(): Metadata {
  return generateMetadata({
    ...
    description:
      "Learn about Pathology Bites, a free educational platform providing comprehensive pathology practice questions and study materials for medical students and professionals.",
    keywords: [
...
export function generateCategoriesPageMetadata(): Metadata {
  return generateMetadata({
    ...
    description:
      "Browse pathology practice questions by category including anatomic pathology, clinical pathology, histopathology, cytopathology, and more.",
    keywords: [
...
export function generateToolsPageMetadata(): Metadata {
  return generateMetadata({
    ...
    description:
      "Free pathology tools including citation generators, reference formatters, and other educational resources for medical students and professionals.",
    keywords: [
      "pathology tools",
...
export function generatePrivacyPageMetadata(): Metadata {
  return generateMetadata({
    ...
    description:
      "Privacy policy for Pathology Bites. Learn how we protect your personal information and data while providing free pathology education.",
...
export function generateTermsPageMetadata(): Metadata {
  return generateMetadata({
    ...
    description:
      "Terms of service for Pathology Bites. Understand the terms and conditions for using our free pathology education platform.",
