      ...
      <Card className="w-full max-w-4xl mx-auto">
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <Button onClick={refreshQuestion} className="mt-4">
              Retry
            </Button>
          </div>
        </CardContent>
    ...
    >
      <Card className="h-full">
        <CardContent className="space-y-4 pt-6">
          <div className="text-sm text-foreground/90">{currentQuestion.body}</div>

          {/* Images */}
          {currentQuestion.images && currentQuestion.images.length > 0 && (
            <div>
              <ImageCarousel images={currentQuestion.images} className="border rounded-lg" />
            </div>
          )}
            ...
            >
              <div className="p-3 rounded-lg bg-muted/50 text-sm space-y-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">{currentQuestion.teachingPoint}</div>
                </div>
                          ...
                          .map(([id, explanation]) => (
                            <div key={id} className="flex gap-2">
                              <span className="font-medium">
                                {getOptionLabel(
                                  id,
                                  currentQuestion.options.findIndex((opt) => opt.id === id)
                                )}
                                .
                              </span>
