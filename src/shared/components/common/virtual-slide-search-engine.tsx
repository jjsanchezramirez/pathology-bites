...
export function VirtualSlideSearchEngine({
  ...
  return (
    <section id={id} className={`relative py-24 bg-muted/75 ${className}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-4xl font-bold">Virtual Slide Search Engine</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-muted-foreground">
                    Search across 11 prestigious institutions including Leeds, PathPresenter, MGH,
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-muted-foreground">
                    High-resolution virtual microscopy for detailed examination
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-muted-foreground">
                    Comprehensive case studies with diagnostic information
                  </p>
                </div>
              </div>
              ...
              <div className="pt-6 text-xs text-muted-foreground">
                <p>
                  <span className="font-medium">Content:</span> Links to third-party repositories.
