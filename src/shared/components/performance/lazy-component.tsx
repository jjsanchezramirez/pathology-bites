...
export function LazyContent({ height = 200, width = "100%", ...props }: LazyContentProps) {
  const fallback = (
    <div
...
export function LazySection({ title, subtitle, ...props }: LazySectionProps) {
  const fallback = (
    <div className="space-y-4 w-full">
      {title && <div className="h-8 w-1/3 bg-gray-100 animate-pulse rounded-md" />}
      {subtitle && <div className="h-6 w-2/3 bg-gray-100 animate-pulse rounded-md" />}
