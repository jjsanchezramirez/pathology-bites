...
export class AIService {
   ...
   */
  async generateWithFallback(request: AIRequest, fallbackModels: string[]): Promise<AIResponse> {
   ...
   */
  async generateWithTPMFallback(request: AIRequest): Promise<AIResponse> {
...
export async function generateWithTPMFallback(request: AIRequest): Promise<AIResponse> {
