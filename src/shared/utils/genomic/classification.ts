...
import { countComputationalEvidence } from "./variant-evidence";

// Re-exported so the genomic barrel surface (export * from "./classification") is unchanged.
export { determineVariantType, detectTechnicalArtifact } from "./variant-evidence";
