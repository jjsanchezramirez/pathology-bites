    ...
    items: [
      {
        ...
        answer: 'A completely FREE pathology education platform powered by AI, offering a comprehensive question bank and learning tools for pathology education.'
      },
      {
        value: 'who-for',
        question: 'Who is PathologyBites for?',
        answer: 'Medical students, residents, fellows, and practicing pathologists looking to enhance their knowledge.'
      },
      {
        value: 'email-req',
        question: 'Do I need an institutional email to sign up?',
        answer: 'No! You can sign up with any email address. We do require an email to track your progress and provide personalized recommendations.'
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'We regularly revise questions based on user feedback and updates in the field. We greatly appreciate user feedback to help maintain content accuracy and relevance.'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        answer: 'Coming soon! We\'re developing native mobile apps for both Android and iOS devices. In the meantime, you can access PathologyBites through your mobile browser for a fully responsive experience.'
      },
      {
        value: 'progress',
      ...
      },
      {
        ...
        answer: 'Through our contact form. We value your feedback and use it to continuously improve the platform.'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        answer: 'We\'re excited to partner with institutions! Contact us to discuss how we can work together to support your educational goals.'
      },
      {
        value: 'analytics',
    ...
    items: [
      {
        ...
        answer: 'Yes! PathologyBites is completely free. Our AI-powered approach allows us to maintain high quality while eliminating costs. If you\'re interested in contributing or participating in our development, please reach out.'
      }
    ]
  },
  {
