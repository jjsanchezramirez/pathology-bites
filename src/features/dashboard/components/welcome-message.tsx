        ...
        <div className="pr-8">
          ...
          <div className="text-sm text-muted-foreground space-y-2 mb-4">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <strong>Practice Quizzes:</strong> Test yourself with expert-curated multiple-choice questions
              </li>
              <li>
                <strong>Slide-Based Questions:</strong> Analyze whole slide images with AI-generated multiple-choice questions
              </li>
              <li>
                <strong>Ankoma Deck Viewer:</strong> Master concepts with the most comprehensive Anki pathology deck ever built
              </li>
            </ul>

            <p>
              Start with a quiz to assess your current knowledge, or explore our other learning tools.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-3">
            <Link href="/dashboard/quiz/new" className="flex-1 min-w-0">
              ...
              >
                ...
                <span className="whitespace-nowrap overflow-hidden text-ellipsis">Create Your First Quiz</span>
              </Button>
            </Link>
            <Link href="/dashboard/wsi-questions" className="flex-1 min-w-0">
              ...
              >
                ...
                <span className="whitespace-nowrap overflow-hidden text-ellipsis">Slide-Based Questions</span>
              </Button>
            </Link>
            <Link href="/dashboard/anki" className="flex-1 min-w-0">
              ...
              >
                ...
                <span className="whitespace-nowrap overflow-hidden text-ellipsis">Ankoma Deck Viewer</span>
              </Button>
            </Link>
          </div>
        </div>
