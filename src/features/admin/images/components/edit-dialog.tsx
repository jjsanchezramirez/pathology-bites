...
import { updateImage } from "@/features/admin/images/services/images";
import { ImageData, IMAGE_CATEGORIES, ImageCategory } from "@/shared/types/images";
import { useImageReupload } from "@/features/admin/images/hooks/use-image-reupload";
