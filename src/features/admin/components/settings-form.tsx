  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <select
                id="defaultDifficultyFilter"
                value={settings.defaultDifficultyFilter}
                onChange={(e) => setSettings(prev => ({ ...prev, defaultDifficultyFilter: e.target.value as any }))}
            ...
            <div className="grid gap-2">
              ...
              <select
                id="defaultQuestionTypeFilter"
                value={settings.defaultQuestionTypeFilter}
                onChange={(e) => setSettings(prev => ({ ...prev, defaultQuestionTypeFilter: e.target.value as any }))}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-4">
            <h4 className="text-sm font-medium">Dashboard Widgets</h4>
          ...
          <div className="grid gap-2">
            ...
            <select
              ...
              onChange={(e) => setSettings(prev => ({ ...prev, dashboardLayout: e.target.value as any }))}
              className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
              <option value="compact">Compact (more widgets per row)</option>
              <option value="detailed">Detailed (larger widgets with more info)</option>
            </select>
          </div>
        </CardContent>
      </Card>
