...
import { QuestionWithDetails, QuestionImageFormData } from "@/shared/types/questions";
                    ...
                    <div className="grid grid-cols-7 gap-2">
                      {availableImages.length === 0 && !loading ? (
                        ...
                        availableImages.map((image) => {
                          ...
                          const isAlreadyAdded = sectionImages.some(
                            (img) => img.image_id === image.id
                          );
                          const canSelect =
                            !isAlreadyAdded &&
                            (selectedImageIds.length < maxImages - sectionImages.length ||
                              isSelected);
    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Add images to enhance your question. You can add up to 3 images in the question stem and 1
          image in the explanation.
        </p>
      </div>
