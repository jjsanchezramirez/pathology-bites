...
function MediaSection({ images, section, maxImages, onImagesChange }: MediaSectionProps) {
  ...
  // Load images for existing question images immediately
  const loadExistingImages = useCallback(async () => {
    ...
    try {
      ...
      const result = await fetchImages({
        page: 0,
        pageSize: 50, // Load more to ensure we get existing images
...
export function MediaTab({ question, onUnsavedChanges, questionImages, onQuestionImagesChange }: MediaTabProps) {
