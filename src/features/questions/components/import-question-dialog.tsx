  ...
  const onSubmit = async (_data: FormData) => {
    ...
    if (!hasCorrectAnswer) {
      validationErrors.push(
        "At least one question option must be marked as correct (is_correct: true)"
      );
    }
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (errorText.includes("foreign key constraint") && errorText.includes("question_set_id")) {
          errorMessage =
            "Invalid question_set_id: The specified question set does not exist. Please check the Question Sets management page for valid UUIDs.";
        } else if (
          errorText.includes("foreign key constraint") &&
          errorText.includes("created_by")
        ) {
          errorMessage =
            "Authentication error: Invalid user. Please refresh the page and try again.";
        } else if (errorText.includes("foreign key constraint")) {
          errorMessage =
            "Invalid reference: One or more UUIDs reference non-existent records. Please verify all UUIDs exist in the database.";
        } else if (errorText.includes("violates check constraint")) {
          errorMessage =
            "Invalid data: One or more fields contain invalid values. Please check the format requirements.";
      ...
      <DialogPortal>
        ...
        <DialogContent className="w-full max-w-[min(85vw,800px)] sm:max-w-[min(85vw,800px)] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Import a question by providing JSON data. The JSON should include all question
              details, answer options, and related data.
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="mt-3 text-sm text-muted-foreground space-y-3">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      <li>
                        <strong>title:</strong> Question title (1-200 characters)
                      </li>
                      <li>
                        <strong>stem:</strong> Main question text (10-2000 characters)
                      </li>
                      <li>
                        <strong>difficulty:</strong> "easy", "medium", or "hard"
                      </li>
                      <li>
                        <strong>teaching_point:</strong> Educational explanation (10-1000
                        characters)
                      </li>
                      <li>
                        <strong>question_options:</strong> Array of 2-10 question options
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      <li>
                        <strong>text:</strong> Answer option text (required)
                      </li>
                      <li>
                        <strong>is_correct:</strong> true/false (required)
                      </li>
                      <li>
                        <strong>explanation:</strong> Why this option is correct/incorrect
                        (optional)
                      </li>
                      <li>
                        <strong>order_index:</strong> Display order starting from 0 (required)
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      <li>
                        <strong>question_references:</strong> Citation text (max 1000 characters)
                      </li>
                      <li>
                        <strong>status:</strong> "draft" or "approved" (defaults to "draft")
                      </li>
                      <li>
                        <strong>question_set_id:</strong> UUID of existing question set
                      </li>
                      <li>
                        <strong>question_images:</strong> Array of image associations
                      </li>
                      <li>
                        <strong>tag_ids:</strong> Array of existing tag UUIDs
                      </li>
                      <li>
                        <strong>category_ids:</strong> Array of existing category UUIDs
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      <li>
                        <strong>image_id:</strong> UUID of existing image in database
                      </li>
                      <li>
                        <strong>question_section:</strong> "stem" or "explanation"
                      </li>
                      <li>
                        <strong>order_index:</strong> Display order starting from 0
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded border border-yellow-200 dark:border-yellow-800">
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2 text-yellow-700 dark:text-yellow-300">
                      <li>
                        <strong>All UUIDs must reference existing records in the database</strong>
                      </li>
                      <li>
                        To find UUIDs, check the respective management pages (Question Sets, Tags,
                        Categories, Images)
                      </li>
                      <li>
                        If optional arrays are empty, you can omit them or use empty arrays []
                      </li>
                      <li>At least one answer option must have is_correct: true</li>
                      <li>
                        Answer options and question images must have unique order_index values
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-200 dark:border-blue-800">
                    ...
                    <p className="text-blue-700 dark:text-blue-300">
                      Start with a simple question using only required fields (title, stem,
                      difficulty, teaching_point, question_options). Once that works, add optional
                      fields like question_set_id, tags, and categories.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              {parsedData && !validationError && (
                <Alert>
                  ...
                  <AlertDescription>
                    JSON is valid! Question "{parsedData.title}" with{" "}
                    {parsedData.question_options.length} question options ready to import.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="flex justify-end gap-3">
                ...
                <Button type="submit" disabled={isSubmitting || !parsedData || !!validationError}>
                  {isSubmitting ? (
                    <>
