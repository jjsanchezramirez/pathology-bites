    ...
    <div className="space-y-4">
      ...
      <div className="bg-muted/50 p-3 rounded text-sm">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <span className="font-medium">Version:</span> {version.version_string}
          </div>
          <div>
          ...
          <div>
            ...
            {version.update_type.charAt(0).toUpperCase() + version.update_type.slice(1)}
          </div>
          <div>
            <span className="font-medium">
              {version.version_string === "v1.0.0" ? "Created by" : "Last updated by"}:
            </span>{" "}
            {version.creator
