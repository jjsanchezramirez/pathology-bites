...
function TestAuthComponent() {
  const { user, isAuthenticated, isLoading, error, securityRisk, refreshAuth } = useAuth()
...
describe('Auth Integration Tests', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should display authentication errors correctly', () => {
      ...
      expect(screen.getByText('Please check your email and password and try again.')).toBeInTheDocument()
  ...
  describe('Security Monitor', () => {
    ...
    it('should show security warnings for authenticated users with risks', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/High security risk detected/)).toBeInTheDocument()
      })
    })
  })
})
