...
def main():
    """Consolidate categories and organ systems in the filtered virtual slides data."""
    script_dir = Path(__file__).parent
    filtered_file = script_dir.parent / 'virtual-slides-filtered.json'

    if not filtered_file.exists():
        print(f"Error: {filtered_file} not found")
        return

    print("Loading filtered virtual slides data (same as used in search algorithm)...")
