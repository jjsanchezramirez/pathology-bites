...
describe('UnifiedSidebar', () => {
  ...
  it('should render all navigation items for admin user', () => {
    ...
    render(<UnifiedSidebar isCollapsed={false} navigationItems={adminNavigationItems} />)
  ...
  it('should render collapsed sidebar correctly', () => {
    ...
    render(<UnifiedSidebar isCollapsed={true} navigationItems={adminNavigationItems} />)
