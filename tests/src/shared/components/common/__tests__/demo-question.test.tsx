...
const mockUseDemoQuestions = useDemoQuestions as jest.MockedFunction<typeof useDemoQuestions>;
...
describe('DemoQuestion', () => {
  ...
  it('renders question title and body', () => {
    ...
    expect(screen.getByText('This is a test question body.')).toBeInTheDocument();
  });
  ...
  it('shows teaching point after selecting an answer', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('This is the teaching point.')).toBeInTheDocument();
    });
  });
