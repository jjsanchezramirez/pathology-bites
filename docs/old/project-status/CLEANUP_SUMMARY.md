...
#### Data Files → `data/`
- `content_specifications_merged.json` → `src/data/content_specifications_merged.json`
...
- **`merge_json.py`**: Updated output path to `src/data/content_specifications_merged.json`
- **`count_designations.py`**: Updated to work with content specifications instead of pathology outlines
- **`count_designations.py`**: Updated input path to `src/data/content_specifications_merged.json`
...
python3 tools/scripts/test-organization.py
```
